...
import com.example.xxy.lovell.spannable.CircleMovementMethod;
import com.example.xxy.lovell.spannable.SpannableClickable;
...
public class CommentListView extends LinearLayout {
    ...
    private View getView(final int position){
        ...
        TextView commentTv = (TextView) convertView.findViewById(R.id.comment_content);
