package com.example.xxy.lovell.view;
...
import com.example.xxy.lovell.adapter.MyWrapAdapter;
    ...
    public void setAdapter(Adapter adapter) {
        ...
        headerView.post(new Runnable() {
            ...
            public void run() {
                ...
                Log.e("高度",headerViewHeight+"  "+headerView.getBottom()+" "+headerView.getTop());
        ...
        Log.e("换了view","");
        LinearLayout  footerLayout= (LinearLayout) LayoutInflater.from(getContext()).inflate(R.layout.view_more_progress, null);
