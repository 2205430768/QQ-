package com.example.xxy.lovell.utils;
...
*/
    /*public static void detectKeyboard(CommentActivity activity) {
     ...
     */
    /*public static void detectKeyboard(final CommentActivity activity, final OnKeyboardEventListener listener) {
